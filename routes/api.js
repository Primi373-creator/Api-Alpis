...
router.get('/api/ai/cai', cekKey, async (req, res) => {
    ...
    try {
        const response = await axios.get(`https://c.ai.alpha-md.rf.gd/get-output?characterid=${encodeURIComponent(characterId)}&message=${encodeURIComponent(message)}`);
        const result = {
